...
CATEGORIES = [
    ...
    },
    {
        ...
        "title": "جستجوی جهانی",
        "commands": [
            f"`{PREFIX}جستجو` `<عبارت>` — جستجو در یادداشت‌ها، حافظه‌ی AI، پروفایل‌ها، اینباکس، کارهای زمان‌بندی‌شده",
        ],
    },
    {
        "key": "smart_reply",
    ...
    },
    {
        ...
        "title": "پلاگین‌ها",
        "commands": [
            f"`{PREFIX}پلاگین` — لیستِ پلاگین‌های بارگذاری‌شده از `plugins/` (نیازمندِ ری‌استارت بعدِ اضافه‌کردن)",
        ],
    },
    {
        "key": "autopost",
