"""
وضعیتِ «مدیریت گروه پیشرفته» (فیلترلینک + خوش‌آمدگویی) - PostgreSQL از طریق
Repository Layer، دقیقاً مثل بقیه‌ی storeها: یک دیکشنریِ درون‌حافظه‌ای که
Handlerها مستقیم بهش رفرنس دارن، init_group_guard_state() موقع استارتاپ
(bot/db/bootstrap.py) پرش می‌کنه.
"""
